/*************************************************** 
  This is an example for the TMP006 Contact-less Infrared Thermopile Sensor For ESP Board Family

  Designed specifically to work with the Adafruit TMP006 Breakout 
  ----> https://www.adafruit.com/products/1296

  These displays use I2C to communicate, 2 pins are required to  
  interface and you can change it by passing both pin
  ...
  NOTE: If you run this code on non ESP Board family, the PIN change will not make
  any effect and it will use the default PIN
 ****************************************************/
...
// Just change to any GPIO Pin you like
#define SDA_PIN 21 
#define SCL_PIN 22 
...
void setup() { 
  ...
  if (! tmp006.begin(SDA_PIN, SCL_PIN)) {
